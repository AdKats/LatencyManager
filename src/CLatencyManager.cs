...
namespace PRoConEvents
{
    public class CLatencyManager : PRoConPluginAPI, IPRoConPluginInterface
    {
        ...
        private Int32 intPlayerLimit;
        private Int32 intCheckMissingPingAfter;
        private Int32 intPingLimit;
        private Int32 intAverageMinCount;
        private Int32 intAverageAccuracy;
        private Boolean boolPlayerLimitReached;
        ...
        private Dictionary<String, Int32> dicMissingPings;
        ...
        private enumBoolYesNo IgnoreWhitelistForCountryKick; // EDIT EBASSIE
        private enumBoolYesNo IgnoreThresholdForCountryKick; // EDIT EBASSIE
        private enumBoolYesNo IgnoreWhitelistForMissingPing; // EDIT EBASSIE

        private Dictionary<String, LinkedList<Int32>> dicPlayerPings;
        private Dictionary<String, Int32> dicPingCalled;
        ...
        public CLatencyManager()
        {
            ...
            this.dicPlayerPings = new Dictionary<String, LinkedList<Int32>>();
            this.intAverageAccuracy = 20;
            this.intAverageMinCount = 2;
            this.dicPingCalled = new Dictionary<String, Int32>();
            this.dicMissingPings = new Dictionary<String, Int32>();

            //General
            this.intPlayerLimit = 16;
            this.intCheckMissingPingAfter = 300; // EDIT EBASSIE.
            ...
            this.IgnoreWhitelistForCountryKick = enumBoolYesNo.No; // EDIT EBASSIE
            this.IgnoreThresholdForCountryKick = enumBoolYesNo.No; // EDIT EBASSIE
            this.IgnoreWhitelistForMissingPing = enumBoolYesNo.No; // EDIT EBASSIE
...
";
        ...
        public void OnPluginEnable()
        {
            ...
            this.ExecuteCommand("procon.protected.tasks.add", "CountryCheckerTask", "1", "5", "-1", "procon.protected.plugins.call", "CLatencyManager", "CountryCheck");
            ...
            this.dicMissingPings.Clear(); // EDIT EBASSIE
            VersionCheck();
        }
        ...
        public List<CPluginVariable> GetDisplayPluginVariables()
        {
            ...
            if (this.enablePingKick == enumBoolYesNo.Yes)
            {
                ...
                {
                    lstReturn.Add(new CPluginVariable("Ping Functions|Pings to sample for average", typeof(Int32), this.intAverageAccuracy));
                    lstReturn.Add(new CPluginVariable("Ping Functions|Minimum pings before kicking", typeof(Int32), this.intAverageMinCount));
                }
                lstReturn.Add(new CPluginVariable("Ping Functions|Ping limit", typeof(Int32), this.intPingLimit));
                lstReturn.Add(new CPluginVariable("Ping Functions|High ping kick message", typeof(String), this.strPingKickMessage));
                lstReturn.Add(new CPluginVariable("Ping Functions|Kick no ping?", typeof(enumBoolYesNo), this.enableNoPingKick));
            }
            ...
            lstReturn.Add(new CPluginVariable("Settings|Minimum players before rule enforced (0: none)", typeof(Int32), this.intPlayerLimit));
            lstReturn.Add(new CPluginVariable("Settings|Start checking missing ping after (seconds)", typeof(Int32), this.intCheckMissingPingAfter)); // EDIT EBASSIE
            lstReturn.Add(new CPluginVariable("Settings|Ignore whitelist for country kicker", typeof(enumBoolYesNo), this.IgnoreWhitelistForCountryKick)); // EDIT EBASSIE
            lstReturn.Add(new CPluginVariable("Settings|Ignore player threshold for country kicker", typeof(enumBoolYesNo), this.IgnoreThresholdForCountryKick)); // EDIT EBASSIE
            lstReturn.Add(new CPluginVariable("Settings|Ignore whitelist for missing ping", typeof(enumBoolYesNo), this.IgnoreWhitelistForMissingPing)); // EDIT EBASSIE
        ...
        public List<CPluginVariable> GetPluginVariables()
        {
            ...
            lstReturn.Add(new CPluginVariable("Ping limit", typeof(Int32), this.intPingLimit));
            lstReturn.Add(new CPluginVariable("High ping kick message", typeof(String), this.strPingKickMessage));
            lstReturn.Add(new CPluginVariable("Pings to sample for average", typeof(Int32), this.intAverageAccuracy));
            lstReturn.Add(new CPluginVariable("Minimum pings before kicking", typeof(Int32), this.intAverageMinCount));
            lstReturn.Add(new CPluginVariable("Kick no ping?", typeof(enumBoolYesNo), this.enableNoPingKick));
            lstReturn.Add(new CPluginVariable("Debug messages?", typeof(enumBoolYesNo), this.debugMessages));
            lstReturn.Add(new CPluginVariable("Minimum players before rule enforced (0: none)", typeof(Int32), this.intPlayerLimit));
            lstReturn.Add(new CPluginVariable("Start checking missing ping after (seconds)", typeof(Int32), this.intCheckMissingPingAfter));  // EDIT EBASSIE
            lstReturn.Add(new CPluginVariable("Ignore whitelist for country kicker", typeof(enumBoolYesNo), this.IgnoreWhitelistForCountryKick)); // EDIT EBASSIE
            lstReturn.Add(new CPluginVariable("Ignore player threshold for country kicker", typeof(enumBoolYesNo), this.IgnoreThresholdForCountryKick)); // EDIT EBASSIE
            lstReturn.Add(new CPluginVariable("Ignore whitelist for missing ping", typeof(enumBoolYesNo), this.IgnoreWhitelistForMissingPing)); // EDIT EBASSIE
        ...
        public void SetPluginVariable(String strVariable, String strValue)
        {
            ...
            else if (strVariable.CompareTo("Ping limit") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Kick no ping?") == 0 && Enum.IsDefined(typeof(enumBoolYesNo), strValue) == true)
            {
                this.enableNoPingKick = (enumBoolYesNo)Enum.Parse(typeof(enumBoolYesNo), strValue);
            }

            else if (strVariable.CompareTo("Pings to sample for average") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Minimum pings before kicking") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            // GENERAL VARIABLES
            else if (strVariable.CompareTo("Minimum players before rule enforced (0: none)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            /* EDIT EBASSIE */
            else if (strVariable.CompareTo("Start checking missing ping after (seconds)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
                this.intCheckMissingPingAfter = iValue;
            }
            else if (strVariable.CompareTo("Ignore whitelist for country kicker") == 0 && Enum.IsDefined(typeof(enumBoolYesNo), strValue) == true)
            {
                this.IgnoreWhitelistForCountryKick = (enumBoolYesNo)Enum.Parse(typeof(enumBoolYesNo), strValue);
            }
            else if (strVariable.CompareTo("Ignore player threshold for country kicker") == 0 && Enum.IsDefined(typeof(enumBoolYesNo), strValue) == true)
            {
                this.IgnoreThresholdForCountryKick = (enumBoolYesNo)Enum.Parse(typeof(enumBoolYesNo), strValue);
            }
            else if (strVariable.CompareTo("Ignore whitelist for missing ping") == 0 && Enum.IsDefined(typeof(enumBoolYesNo), strValue) == true)
            {
                this.IgnoreWhitelistForMissingPing = (enumBoolYesNo)Enum.Parse(typeof(enumBoolYesNo), strValue);
            }
            /* END EDIT EBASSIE */
        ...
        public override void OnPlayerLeft(CPlayerInfo cpiPlayer)
        {
            ...
            if (this.dicMissingPings.ContainsKey(cpiPlayer.SoldierName) == true) // EDIT EBASSIE
            {
                this.dicMissingPings.Remove(cpiPlayer.SoldierName);
            }
        }
        ...
        public override void OnListPlayers(List<CPlayerInfo> lstPlayers, CPlayerSubset cpsSubset)
        {
            if ((lstPlayers != null))
            {
                foreach (CPlayerInfo playerInfo in lstPlayers)
                {
                    ...
                    if ((this.enableNoPingKick == enumBoolYesNo.Yes) && ((playerInfo.Ping <= 0) || (playerInfo.Ping > 10000)) && (!this.lsWhitelist.Contains(playerInfo.SoldierName)))
                    {
                        Int32 SessionTime = playerInfo.SessionTime;

                        if (SessionTime >= intCheckMissingPingAfter) // Start checking for missing ping after xxx seconds.
                        {
                            if (this.dicMissingPings.ContainsKey(playerInfo.SoldierName))
                            {
                                Int32 missCounts = this.dicMissingPings[playerInfo.SoldierName];

                                if (missCounts <= 4)
                                {
                                    DebugMessage(String.Format("^8Warning " + missCounts + " - Missing Ping: " + playerInfo.SoldierName + " (" + SessionTime + ")"));
                                    this.ExecuteCommand("procon.protected.chat.write", "^b[LatencyManager]^n ^8" + playerInfo.SoldierName + " has no ping. (" + missCounts + ")^0");
                                    this.dicMissingPings[playerInfo.SoldierName] = missCounts + 1;
                                }
                                else if (missCounts <= 9)
                                {
                                    DebugMessage(String.Format("^8Warning " + missCounts + " - Missing Ping: " + playerInfo.SoldierName + " "));
                                    this.ExecuteCommand("procon.protected.send", "admin.say", "" + playerInfo.SoldierName + ", please fix your missing ping or be kicked", "player", playerInfo.SoldierName);
                                    this.ExecuteCommand("procon.protected.chat.write", "^b[LatencyManager] ^8" + playerInfo.SoldierName + ", please fix your missing ping or be kicked^0^n");

                                    this.dicMissingPings[playerInfo.SoldierName] = missCounts + 1;
                                }
                                else if (missCounts >= 10)
                                {
                                    Kick(playerInfo.SoldierName, "[Auto-Admin] Missing ping", "", "");
                                    DebugMessage(String.Format("^8Kicking for Missing Ping: " + playerInfo.SoldierName + " "));
                    ...
                    //if(!this.strGameMode.Equals("BF3")) // BF3 FIX, now works same as BF4
                    //{
        ...
        {
            //EDIT EBASSIE
            if ((this.enableNoPingKick == enumBoolYesNo.Yes) && ((ping <= 0) || (ping > 10000)) && (!this.lsWhitelist.Contains(soldierName)))
            {
                if (this.dicMissingPings.ContainsKey(soldierName))
                {
                    Int32 missCounts = this.dicMissingPings[soldierName];

                    if (missCounts <= 4)
                    {
                        DebugMessage(String.Format("^8Warning " + missCounts + " - Missing Ping: " + soldierName + " "));
                        this.ExecuteCommand("procon.protected.chat.write", "^b[LatencyManager^0]^n ^8" + soldierName + " has no ping. (" + missCounts + ")^0");
                        this.dicMissingPings[soldierName] = missCounts + 1;
                    }
                    else if (missCounts <= 9)
                    {
                        DebugMessage(String.Format("^8Warning " + missCounts + " - Missing Ping: " + soldierName + " "));
                        this.ExecuteCommand("procon.protected.send", "admin.say", "" + soldierName + ", please fix your missing ping or be kicked", "player", soldierName);
                        this.ExecuteCommand("procon.protected.chat.write", "^b[LatencyManager] ^8" + soldierName + ", please fix your missing ping or be kicked^0^n");
                        this.dicMissingPings[soldierName] = missCounts + 1;
                    }
                    else if (missCounts >= 10)
                    {
                        Kick(soldierName, "[Auto-Admin] Missing ping", "", "");
                        DebugMessage(String.Format("^8Kicking for Missing Ping: " + soldierName + " "));
        ...
        public void PingAdd(String strSoldierName, String ping)
        {
            if (this.lsPlayerInfo.Contains(strSoldierName) == true)
            {
                ...
                {
                    this.dicPingCalled[strSoldierName] = Int32.Parse(ping);
                }
                else
                {
                    this.dicPingCalled.Add(strSoldierName, Int32.Parse(ping));
                }
            }
            else
            {
        ...
        public void PingCheck()
        {
            if (this.enablePingKick == enumBoolYesNo.Yes)
            {
                ...
                foreach (KeyValuePair<String, Int32> latestPings in this.dicPingCalled)
                {
                    ...
                    if ((this.lsPlayerInfo.Contains(latestPings.Key) == true) && (latestPings.Value > 0) && (latestPings.Value < 10000) && (!this.lsWhitelist.Contains(latestPings.Key)))
                    {
                        if (this.strPingMethod.CompareTo("Average ping") == 0)
                        {
                            ...
                            {
                                LinkedList<Int32> playerPings = this.dicPlayerPings[latestPings.Key];
                            ...
                            {
                                LinkedList<Int32> newPing = new LinkedList<Int32>();
        ...
        public void CountryCheck() // EDIT EBASSIE
        {
            if (this.enableCountryKick == enumBoolYesNo.Yes)
            {
                foreach (KeyValuePair<String, String> cpbiPlayer in this.dicCountrys)
                {
                    if ((this.lsSelectedCountries == null) || (this.lsSelectedCountries.Count == 0) || (this.lsCheckedPlayers.Contains(cpbiPlayer.Key)))
                    {
                        if (this.lsWhitelist.Contains(cpbiPlayer.Key))
                        {
                            //Do nothing.
                        }
                    }
                    ...
                    {
                        if ((this.IgnoreThresholdForCountryKick == enumBoolYesNo.Yes) && (!this.boolPlayerLimitReached))
                        {
                            if (this.lsWhitelist.Contains(cpbiPlayer.Key))
                            {
                                if (this.IgnoreWhitelistForCountryKick == enumBoolYesNo.Yes)
                                {
                        ...
                        else if ((this.IgnoreThresholdForCountryKick == enumBoolYesNo.No) && (this.boolPlayerLimitReached))
                        {
                            if (this.lsWhitelist.Contains(cpbiPlayer.Key))
                            {
                                if (this.IgnoreWhitelistForCountryKick == enumBoolYesNo.Yes)
